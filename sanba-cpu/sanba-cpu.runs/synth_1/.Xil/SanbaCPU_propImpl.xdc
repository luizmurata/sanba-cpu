set_property SRC_FILE_INFO {cfile:{D:/src/sanba-cpu/sanba-cpu/Nexys4DDR Master Constraint file.xdc} rfile:{../../../Nexys4DDR Master Constraint file.xdc} id:1} [current_design]
